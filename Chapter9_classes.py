...
#
# my_restaurant = Restaurant("spanky's", "hot dog")
# my_restaurant.describe_restaurant()
# my_restaurant.set_number_served(10)
# print(my_restaurant.name.title() + " has served " + str(my_restaurant.number_served) + " customers")
# my_restaurant.increment_number_served(5)
# print(my_restaurant.name.title() + " has now served " + str(my_restaurant.number_served) + " customers")
#
# Exercise 9-11 Imported Admin

# import making_users
# my_user = making_users.Admin("nicholas", "johnson", "bdn81", "6.5", "147")
# my_user.admin_privileges.show_privilege()
# my_user.describe_user()

# Exercise 9-12 Multiple Modules
#
# import make_admin_user
# my_user = make_admin_user.Admin("nicholas", "johnson", "BSN81", "12.5", "1")
# my_user.admin_privileges.show_privilege()
# my_user.describe_user()
